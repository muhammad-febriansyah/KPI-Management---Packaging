    ...
    <div class="w-full max-w-xl rounded-xl bg-white p-6 shadow-xl">
        ...
        <form data-super-admin-form class="grid gap-4">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <label class="grid gap-2 text-sm font-semibold"><span>Password <span class="text-danger" data-password-required-mark>*</span></span><input type="password" name="password" data-required-on-create autocomplete="new-password" class="h-11 rounded-lg border border-line px-3 font-normal" placeholder="Minimal 8 karakter"></label>
                <label class="grid gap-2 text-sm font-semibold"><span>Konfirmasi password <span class="text-danger" data-password-required-mark>*</span></span><input type="password" name="password_confirmation" data-required-on-create autocomplete="new-password" class="h-11 rounded-lg border border-line px-3 font-normal" placeholder="Ulangi password"></label>
            </div>
